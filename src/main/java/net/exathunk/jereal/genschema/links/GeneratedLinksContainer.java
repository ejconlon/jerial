...
public class GeneratedLinksContainer {
    ...
    private final Ref<GeneratedLinks> objectValue;
    ...
    public GeneratedLinksContainer() {
        ...
        objectValue = new RefImpl<GeneratedLinks>();
    ...
    public GeneratedLinks getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedLinks value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedLinks> getObjectValueRef() {
        return objectValue;
    }
