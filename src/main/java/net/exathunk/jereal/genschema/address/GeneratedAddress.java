...
public class GeneratedAddress implements GeneratedAddressLike, GeneratedAddressRefable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GeneratedAddress{ ");
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof GeneratedAddressLike) {
            GeneratedAddressLike other = (GeneratedAddressLike) o;
            if (hasCountryName()) {
            ...
            return true;
        } else if (o instanceof GeneratedAddressRefable) {
            GeneratedAddressRefable other = (GeneratedAddressRefable) o;
