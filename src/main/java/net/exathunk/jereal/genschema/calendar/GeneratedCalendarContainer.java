...
public class GeneratedCalendarContainer {
    ...
    private final Ref<GeneratedCalendar> objectValue;
    ...
    public GeneratedCalendarContainer() {
        ...
        objectValue = new RefImpl<GeneratedCalendar>();
    ...
    public GeneratedCalendar getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedCalendar value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedCalendar> getObjectValueRef() {
        return objectValue;
    }
