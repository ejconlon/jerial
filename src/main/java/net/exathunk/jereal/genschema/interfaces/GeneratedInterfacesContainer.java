...
public class GeneratedInterfacesContainer {
    ...
    private final Ref<GeneratedInterfaces> objectValue;
    ...
    public GeneratedInterfacesContainer() {
        ...
        objectValue = new RefImpl<GeneratedInterfaces>();
    ...
    public GeneratedInterfaces getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedInterfaces value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedInterfaces> getObjectValueRef() {
        return objectValue;
    }
