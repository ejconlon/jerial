...
public class GeneratedGeo implements GeneratedGeoLike, GeneratedGeoRefable {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("GeneratedGeo{ ");
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof GeneratedGeoLike) {
            GeneratedGeoLike other = (GeneratedGeoLike) o;
            if (hasLatitude()) {
            ...
            return true;
        } else if (o instanceof GeneratedGeoRefable) {
            GeneratedGeoRefable other = (GeneratedGeoRefable) o;
