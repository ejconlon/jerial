...
public class GeneratedGeoContainer {
    ...
    private final Ref<GeneratedGeo> objectValue;
    ...
    public GeneratedGeoContainer() {
        ...
        objectValue = new RefImpl<GeneratedGeo>();
    ...
    public GeneratedGeo getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedGeo value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedGeo> getObjectValueRef() {
        return objectValue;
    }
