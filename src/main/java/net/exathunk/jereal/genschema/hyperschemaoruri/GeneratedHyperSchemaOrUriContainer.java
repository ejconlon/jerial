...
public class GeneratedHyperSchemaOrUriContainer {
    ...
    private final Ref<GeneratedHyperSchemaOrUri> objectValue;
    ...
    public GeneratedHyperSchemaOrUriContainer() {
        ...
        objectValue = new RefImpl<GeneratedHyperSchemaOrUri>();
    ...
    public GeneratedHyperSchemaOrUri getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedHyperSchemaOrUri value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedHyperSchemaOrUri> getObjectValueRef() {
        return objectValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof GeneratedHyperSchemaOrUriContainer) {
            GeneratedHyperSchemaOrUriContainer other = (GeneratedHyperSchemaOrUriContainer) o;
            if (hasArrayValue()) {
