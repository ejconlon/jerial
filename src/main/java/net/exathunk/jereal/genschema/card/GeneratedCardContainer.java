...
public class GeneratedCardContainer {
    ...
    private final Ref<GeneratedCard> objectValue;
    ...
    public GeneratedCardContainer() {
        ...
        objectValue = new RefImpl<GeneratedCard>();
    ...
    public GeneratedCard getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedCard value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedCard> getObjectValueRef() {
        return objectValue;
    }
