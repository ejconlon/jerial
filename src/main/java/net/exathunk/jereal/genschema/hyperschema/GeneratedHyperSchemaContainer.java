...
public class GeneratedHyperSchemaContainer {
    ...
    private final Ref<GeneratedHyperSchema> objectValue;
    ...
    public GeneratedHyperSchemaContainer() {
        ...
        objectValue = new RefImpl<GeneratedHyperSchema>();
    ...
    public GeneratedHyperSchema getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedHyperSchema value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedHyperSchema> getObjectValueRef() {
        return objectValue;
    }
