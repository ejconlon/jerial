...
public class GeneratedJsonRefContainer {
    ...
    private final Ref<GeneratedJsonRef> objectValue;
    ...
    public GeneratedJsonRefContainer() {
        ...
        objectValue = new RefImpl<GeneratedJsonRef>();
    ...
    public GeneratedJsonRef getObjectValue() {
        return objectValue.getRef();
    }
    public void setObjectValue(GeneratedJsonRef value) {
        objectValue.setRef(value);
    }
    public Ref<GeneratedJsonRef> getObjectValueRef() {
        return objectValue;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof GeneratedJsonRefContainer) {
            GeneratedJsonRefContainer other = (GeneratedJsonRefContainer) o;
            if (hasArrayValue()) {
