...
public class Schema implements SchemaLike, SchemaRefable {
    ...
    private final Ref<Any2<SchemaContainer,Boolean>> additionalItems;
    private final Ref<Any2<SchemaContainer,Boolean>> additionalProperties;
    private final Ref<String> description;
    private final Ref<Any3<String,List<Any2<String,SchemaContainer>>,SchemaContainer>> disallow;
    ...
    private final Ref<Any2<SchemaContainer,List<SchemaContainer>>> extendsField;
    private final Ref<String> format;
    private final Ref<Any2<SchemaContainer,List<SchemaContainer>>> items;
    ...
    private final Ref<Any2<String,SchemaContainer>> requires;
    private final Ref<String> title;
    private final Ref<Any2<String,List<Any2<String,SchemaContainer>>>> type;
    private final Ref<Boolean> uniqueItems;

    public Schema() {
        additionalItems = new RefImpl<Any2<SchemaContainer,Boolean>>();
        additionalProperties = new RefImpl<Any2<SchemaContainer,Boolean>>();
        description = new RefImpl<String>();
        disallow = new RefImpl<Any3<String,List<Any2<String,SchemaContainer>>,SchemaContainer>>();
        enumField = new RefImpl<List<JThing>>();
        exclusiveMaximum = new RefImpl<Double>();
        exclusiveMinimum = new RefImpl<Double>();
        extendsField = new RefImpl<Any2<SchemaContainer,List<SchemaContainer>>>();
        format = new RefImpl<String>();
        items = new RefImpl<Any2<SchemaContainer,List<SchemaContainer>>>();
        ...
        requires = new RefImpl<Any2<String,SchemaContainer>>();
        title = new RefImpl<String>();
        type = new RefImpl<Any2<String,List<Any2<String,SchemaContainer>>>>();
    ...
    @Override
    public Any2<SchemaContainer,Boolean> getAdditionalItems() {
        return additionalItems.getRef();
    }
    @Override
    public void setAdditionalItems(Any2<SchemaContainer,Boolean> value) {
        additionalItems.setRef(value);
    }
    @Override
    public Ref<Any2<SchemaContainer,Boolean>> getAdditionalItemsRef() {
    ...
    @Override
    public Any2<SchemaContainer,Boolean> getAdditionalProperties() {
        return additionalProperties.getRef();
    }
    @Override
    public void setAdditionalProperties(Any2<SchemaContainer,Boolean> value) {
        additionalProperties.setRef(value);
    }
    @Override
    public Ref<Any2<SchemaContainer,Boolean>> getAdditionalPropertiesRef() {
    ...
    @Override
    public Any3<String,List<Any2<String,SchemaContainer>>,SchemaContainer> getDisallow() {
        return disallow.getRef();
    }
    @Override
    public void setDisallow(Any3<String,List<Any2<String,SchemaContainer>>,SchemaContainer> value) {
        disallow.setRef(value);
    }
    @Override
    public Ref<Any3<String,List<Any2<String,SchemaContainer>>,SchemaContainer>> getDisallowRef() {
        return disallow;
    }
    ...
    @Override
    public Any2<SchemaContainer,List<SchemaContainer>> getExtendsField() {
        return extendsField.getRef();
    }
    @Override
    public void setExtendsField(Any2<SchemaContainer,List<SchemaContainer>> value) {
        extendsField.setRef(value);
    }
    @Override
    public Ref<Any2<SchemaContainer,List<SchemaContainer>>> getExtendsFieldRef() {
        return extendsField;
    }
    ...
    @Override
    public Any2<SchemaContainer,List<SchemaContainer>> getItems() {
        return items.getRef();
    }
    @Override
    public void setItems(Any2<SchemaContainer,List<SchemaContainer>> value) {
        items.setRef(value);
    }
    @Override
    public Ref<Any2<SchemaContainer,List<SchemaContainer>>> getItemsRef() {
        return items;
    }
    ...
    @Override
    public Any2<String,SchemaContainer> getRequires() {
        return requires.getRef();
    }
    @Override
    public void setRequires(Any2<String,SchemaContainer> value) {
        requires.setRef(value);
    }
    @Override
    public Ref<Any2<String,SchemaContainer>> getRequiresRef() {
        return requires;
    }
    ...
    @Override
    public Any2<String,List<Any2<String,SchemaContainer>>> getType() {
        return type.getRef();
    }
    @Override
    public void setType(Any2<String,List<Any2<String,SchemaContainer>>> value) {
        type.setRef(value);
    }
    @Override
    public Ref<Any2<String,List<Any2<String,SchemaContainer>>>> getTypeRef() {
        return type;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof SchemaLike) {
            ...
            return true;
        } else if (o instanceof SchemaRefable) {
