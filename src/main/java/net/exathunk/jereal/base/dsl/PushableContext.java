...
public interface PushableContext<T extends PushableContext<T, U>, U> {
    ...
    void writeObject(RefMapGroup<T, U> group, Cont<U> cont) throws JerializerException;
    void writeArray(RefMapGroup<T, U> group, Cont<U> cont) throws JerializerException;
